        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('index') }}">
                        <p class="text-white font-selif italic font-bold">Football Review</p>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('index')" :active="request()->routeIs('index')" class="text-white">
                     ...
                     <x-nav-link :href="route('index_follow')" :active="request()->routeIs('index_follow')" class="text-white">
                        {{ __('Following') }}
                    </x-nav-link>
